		...
		1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e
			? (s("#dark-mode-switch").prop("checked", !1),
			  ...
			  s("#bootstrap-style").attr(
					"href",
					$("#base_url").val() + "assets_back/css/bootstrap.min.css"
			  ),
			  s("#app-style").attr(
					"href",
					$("#base_url").val() + "assets_back/css/app.min.css"
			  ),
			...
			? (s("#light-mode-switch").prop("checked", !1),
			  ...
			  s("#bootstrap-style").attr(
					"href",
					$("#base_url").val() + "assets_back/css/bootstrap-dark.min.css"
			  ),
			  s("#app-style").attr(
					"href",
					$("#base_url").val() + "assets_back/css/app-dark.min.css"
			  ),
			...
			: 1 == s("#rtl-mode-switch").prop("checked") &&
			  ...
			  s("#app-style").attr(
					"href",
					$("#base_url").val() + "assets_back/css/app-rtl.min.css"
			  ),
