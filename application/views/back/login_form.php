                                        ...
                                        <div class="p-2 mt-5">
                                            <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>login/process">
                                                ...
                                                <div class="form-group d-flex">
                                                    <input type="button" name="shift" class="btn btn-outline-light text-muted shadow-sm flex-fill mx-1" value="D">
                                                    <input type="button" name="shift" class="btn btn-outline-light text-muted shadow-sm flex-fill mx-1" value="S">
                                                    <input type="button" name="shift" class="btn btn-outline-light text-muted shadow-sm flex-fill mx-1" value="N">
                                                </div>
