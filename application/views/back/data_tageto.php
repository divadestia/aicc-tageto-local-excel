...
<body data-topbar="dark">
    ...
    <div id="layout-wrapper">
                                ...
                                <form id="form-data" method="POST">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control numpad" id="charging_date" name="charging_date" placeholder="Enter Charging Date" autocomplete="off" required readonly>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                                                ...
                                                <label class="btn btn-outline-secondary btn-sm">
                                                    <input type="radio" name="model_id" value="4JA1" autocomplete="off"> 4JA1
                                                </label>
                                                <label class="btn btn-outline-secondary btn-sm">
                                                    <input type="radio" name="model_id" value="C240" autocomplete="off"> C240
                                                </label>
                                                <label class="btn btn-outline-secondary btn-sm">
                                                    <input type="radio" name="model_id" value="EJ39" autocomplete="off"> EJ39
                                                </label>
                                                <label class="btn btn-outline-secondary btn-sm">
                                                    <input type="radio" name="model_id" value="EJ40" autocomplete="off"> EJ40
                                                </label>
                                                <label class="btn btn-outline-secondary btn-sm">
                                                    <input type="radio" name="model_id" value="EJ59" autocomplete="off"> EJ59
                                                </label>
                                                <label class="btn btn-outline-secondary btn-sm">
                                                    <input type="radio" name="model_id" value="ES01" autocomplete="off"> ES01
                                                </label>
                                                <label class="btn btn-outline-secondary btn-sm">
                                                    <input type="radio" name="model_id" value="ES30" autocomplete="off"> ES30
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-3 d-flex justify-content-md-end mt-2 mt-md-6">
                                            <button type="submit" class="btn btn-success w-100 w-md-auto px-4"><i class="fas fa-plus"></i> Add Data</button>
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-6">
                                    ...
                                    <table id="datatable1" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                        <thead class="table-dark">
                                            <tr>
                                                ...
                                                <th class="text-center align-middle" rowspan="2" style="min-width: 100px;">Pola</th>
                                                ...
                                                <th class="text-center align-middle" rowspan="2" style="min-width: 100px;">Kijun Bosu 3</th>
                                                <th class="text-center align-middle" rowspan="2">Bosu Cope</th>
                                                <th class="text-center align-middle" rowspan="2" style="min-width: 100px;">By Gauge</th>
                                                <th class="text-center align-middle" rowspan="2" style="min-width: 100px;">Process #2<p>90</p>
                                                </th>
        ...
        <!-- ========== FOOTER ========= -->
        <footer class="bg-white text-center align-middle" style="height:60px; padding:20px; position: relative;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
        ...
        <div id="numpadContainer" class="bg-white border rounded shadow p-22" style="position:absolute; display:none; z-index:9999; width:220px;">
            ...
            <div class="d-flex flex-wrap justify-content-center">
                ...
                <!-- Line 5 -->
                <button class="btn btn-danger m-1 fw-bold text-center" style="width:60px;" onclick="clearNp()">Clear</button>
                <button class="btn btn-dark m-1 fw-bold" style="width:60px;" onclick="cancelNp()"><i class="text-center align-middle ">Cancel</i></button>
        ...
        <?php
        $this->load->view('back/data_tageto_js');
        ?>
</body>
